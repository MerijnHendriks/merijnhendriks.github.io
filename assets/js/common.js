...
class CustomRenderer extends marked.Renderer
{
    ...
    blockquote(quote)
    {
        return `<div class="blog-container px-4 mb-2"><blockquote class="blockquote">${quote}</blockquote></div>`;
    }
    ...
    code(code, language)
    {
        ...
        return `<div class="blog-container p-3 mb-2"><pre class="mb-0"><code class="highlight language-${language}">${highlighted}</code></pre></div>`;
    }
}
