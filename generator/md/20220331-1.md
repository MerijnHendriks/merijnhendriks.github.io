...
In many cases we don't need `goto` to emulate control structures since in most (modern) programming languages alternatives exist, but it is very useful to know regardless for understanding of the inner workings of these constructs as well for preserving knowledge.
